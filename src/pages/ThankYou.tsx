...
const ThankYou = () => {
  ...
  const timeline = [
    { icon: CheckCircle, label: "অর্ডার গ্রহণ", desc: "আপনার অর্ডার সফলভাবে রেকর্ড হয়েছে", done: true },
    { icon: Phone, label: "কনফার্মেশন কল", desc: "আমাদের টিম ১-২ ঘন্টার মধ্যে কল করবে", done: false },
    { icon: Package, label: "প্যাকেজিং", desc: "প্রিমিয়াম গ্লাস জারে যত্নসহকারে প্যাক", done: false },
    { icon: Truck, label: "ডেলিভারি", desc: "ঢাকায় ১-২ দিন, ঢাকার বাইরে ৩-৫ দিন", done: false },
  ];
      ...
      <Card className="max-w-md w-full border-primary/20 shadow-2xl bg-card">
        <CardContent className="pt-8 pb-8 space-y-6">
          <div className="text-center">
            <div className="w-20 h-20 rounded-full bg-secondary/15 flex items-center justify-center mx-auto mb-4">
              ...
              <div key={i} className="flex gap-3 items-start">
                <div className="flex flex-col items-center">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${
                    step.done ? "bg-secondary text-primary-foreground" : "bg-muted text-muted-foreground"
                  }`}>
          ...
          <div className="space-y-3">
            <Button asChild className="w-full bg-gradient-cta text-primary-foreground font-bold rounded-full py-5">
